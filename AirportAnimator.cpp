...
void AirportAnimator::taxiOut(int plane_num)
{
...
void AirportAnimator::takeoff(int plane_num)
{
  int col = plane_num * 8 + left_base + 2;
...
void AirportAnimator::land(int plane_num)
{
  lockScreen();
  WINDOW *planeWin = newwin(3, 9, 16, 10);
...
void AirportAnimator::taxiIn(int plane_num)
{
  int col = plane_num * 8 + left_base + 2;
...
void AirportAnimator::updateStatus(int plane_num, string status)
{
  lockScreen();
...
void AirportAnimator::updatePassengers(int plane_num, int numpassengers)
{
  lockScreen();
...
void AirportAnimator::updateTours(int num_tours)
{
  lockScreen();
